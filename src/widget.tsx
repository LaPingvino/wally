...
// Timeline event capabilities for comments, reactions, and issue history
widgetApi.requestCapabilityToReceiveEvent('eu.kiefte.issue');
...
widgetApi.start();
// Signal to the host that the widget page has loaded and is ready to begin
// capability negotiation. Without this, the host waits 10 s then gives up.
...
Content:
{
  ...
  "id": "eu.kiefte.issue-tracker"
        ...
        <p style={{ marginTop: 4, color: '#999', fontSize: 12 }}>
          Or use the{' '}
          <a href="https://codeberg.org/lapingvino/cinny" style={{ color: '#1976d2' }}>Wally</a>'s
