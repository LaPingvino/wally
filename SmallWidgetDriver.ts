...
export class SmallWidgetDriver extends WidgetDriver {
  ...
  public async validateCapabilities(requested: Set<Capability>): Promise<Set<Capability>> {
    ...
    // If we grant them on a server that doesn't (e.g. Continuwuity), Element Call will
    // try to use delayed events, hit a server error, and may not fall back correctly —
    // leaving no membership events sent and other clients unable to see the call.
